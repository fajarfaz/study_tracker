  ...
  <script type="text/javascript">
      $(document).ready(function(){
        $("#but_submit").click(function(){
          var username = $("#xt_uname").val().trim();
 ...
 <section
    ...
    <div class="flex flex-col items-center h-full lg:flex-row ">
      ...
      <div
          class="flex w-full h-full px-8 width-right-empty-3-5 sm:px-16 py-32 lg:mx-0 mx-auto items-left justify-left" style="background-color: #FCFDFF;">
          <div class="w-full sm:w-7/12 md:w-8/12 lg:w-9/12 xl:w-7/12 mx-auto lg:mx-0">
            ...
            x-data="{ show: false }">
              ...
              <button type="button" id="but_submit" name="but_submit" 
